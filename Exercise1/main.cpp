...
// shape(n) è la matrice n-by-n con gli elementi da 1 a n*n
MatrixXd Shape(const unsigned int& n)
{
 ...
 //rand(n) è la matrice n-by-n con elementi randomici
...
//hilb(n) è la matrice n-by-n con gli elementi 1/(i+j-1)
...
bool SolveSystem(const MatrixXd A, double& detA, double& condA, double& errRel){
